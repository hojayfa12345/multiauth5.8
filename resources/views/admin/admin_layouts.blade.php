...
<html lang="en">
  ...
  @else
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href="#"><i class="icon ion-android-star-outline"></i> Rehan</a></div>
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header wd-200">
              <ul class="list-unstyled user-profile-nav">
                ...
                <li><a href="{{route('admin.password.change')}}"><i class="icon ion-ios-download-outline"></i> Chenge Password</a></li>
